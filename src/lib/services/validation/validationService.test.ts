...
import type { UserSession, LoginCredentials, WizardFormData } from '$lib/types';
...
describe('ValidationService', () => {
  ...
  describe('Login Credentials Validation', () => {
    ...
    it('should reject weak passwords', () => {
      ...
      expect(() => validateLoginCredentials(invalidData)).toThrow('Validation failed');
    });
  ...
  describe('Safe Parse Functionality', () => {
    it('should return success for valid data', () => {
      ...
      const result = validationService.safeParse(LoginCredentialsSchema, validData);
    ...
    it('should return error for invalid data', () => {
      ...
      const result = validationService.safeParse(LoginCredentialsSchema, invalidData);
