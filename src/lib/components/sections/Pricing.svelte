      ...
      <table class="w-full max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        <thead class="bg-gray-100">
          <tr>
            ...
            <th class="p-4 text-center bg-accent-50 text-accent-700 font-bold">TrueForm</th>
          </tr>
        </thead>
        <tbody class="divide-y">
          ...
          <tr class="bg-gray-50">
            ...
            <td class="p-4 text-center text-red-600 font-semibold">40-50+ hours</td>
            <td class="p-4 text-center">~10 oversight</td>
            <td class="p-4 text-center bg-accent-50 font-bold text-green-600">&lt; 2 hours</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="p-4 text-center text-gray-400">Extra $$$</td>
            <td class="p-4 text-center bg-accent-50 font-bold text-green-600">First year FREE</td>
          </tr>
          <tr class="bg-gray-50">
