...
<!-- Main Header -->
<header class="relative bg-white shadow-lg border-b border-gray-100 sticky top-0 z-50">
  <div class="absolute inset-0 bg-gradient-to-r from-white via-gray-50 to-white opacity-60"></div>
