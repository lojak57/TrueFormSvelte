<script lang="ts">
  ...
  import {
    ...
    wizardProgress,
    WIZARD_STEPS,
  } from "./conversationalWizardStore";
  ...
  $: if (
    $conversationalWizard.currentStep === 7 &&
    !$conversationalWizard.trustAcknowledged
  ) {
...
<div class="wizard-container">
  ...
  <div class="progress-container" in:fade={{ duration: 300, delay: 200 }}>
    <div class="progress-bar">
      <div class="progress-fill" style="width: {$wizardProgress.percentage}%" />
    </div>
