<script lang="ts">
  ...
  const colorPalettes = [
    ...
    },
    {
      ...
      gradient: 'linear-gradient(135deg, #92400e 0%, #f59e0b 50%, #fef3c7 100%)'
    },
    {
      id: 'black-white',
      ...
      gradient: 'linear-gradient(135deg, #000000 0%, #374151 50%, #9ca3af 100%)'
    },
    {
      id: 'forest-green',
      label: 'Forest Greens',
      ...
      gradient: 'linear-gradient(135deg, #064e3b 0%, #10b981 50%, #a7f3d0 100%)'
    },
    {
      id: 'purple-luxury',
      label: 'Purple Luxury',
    ...
    },
    {
      ...
      gradient: 'linear-gradient(135deg, #c2410c 0%, #f97316 50%, #fed7aa 100%)'
    },
    {
      id: 'ocean-teal',
      label: 'Ocean Teal',
    ...
    },
    {
      ...
      gradient: 'linear-gradient(135deg, #7f1d1d 0%, #dc2626 40%, #fbbf24 100%)'
    },
    {
      id: 'soft-pastels',
      label: 'Soft Pastels',
      ...
      gradient: 'linear-gradient(135deg, #a78bfa 0%, #fb7185 50%, #fbbf24 100%)'
    },
    {
      id: 'brand-colors',
    ...
    },
    {
      ...
      gradient: 'linear-gradient(135deg, #3b82f6 0%, #10b981 30%, #f59e0b 70%, #ef4444 100%)',
      special: true
    }
  ];
...
<style>
  ...
  .style-classic { background: rgba(255, 255, 255, 0.9); color: #1e40af; }
  .style-muted { background: rgba(255, 255, 255, 0.9); color: #92400e; }
  .style-minimal { background: rgba(255, 255, 255, 0.9); color: #374151; }
  .style-natural { background: rgba(255, 255, 255, 0.9); color: #064e3b; }
  .style-vibrant { background: rgba(255, 255, 255, 0.9); color: #581c87; }
  .style-cool { background: rgba(255, 255, 255, 0.9); color: #0f766e; }
  .style-rich { background: rgba(255, 255, 255, 0.9); color: #7f1d1d; }
  .style-custom { background: rgba(255, 255, 255, 0.9); color: #6366f1; }
  .style-flexible { background: rgba(255, 255, 255, 0.9); color: #374151; }
