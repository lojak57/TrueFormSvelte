...
<div class="step-container" in:fade={{ duration: 400, delay: 100 }}>
  <div in:fly={{ y: 30, duration: 500 }}>
    ...
    <p class="step-subtitle" in:fly={{ y: 20, duration: 400, delay: 300 }}>
      6 months from now, this website is working perfectly. What's happening?
    ...
    >
      <div class="icon">🎯</div>
      <div class="text">
        <strong>Dream big here.</strong> Tell us about the impact, the feelings,
        the business outcomes. The more vivid the picture, the better we can build
        toward that exact vision.
      </div>
    </div>
