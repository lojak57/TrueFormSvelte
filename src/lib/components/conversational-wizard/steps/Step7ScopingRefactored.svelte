<script lang="ts">
  ...
  const addons: Addon[] = [
    ...
    },
    {
      ...
      price: 250,
      description:
        "Online booking system with calendar integration and automated reminders",
      icon: Calendar,
    ...
    },
    {
      ...
      price: 150,
      description:
        "Expert-written content for all pages, optimized for conversions",
      icon: Edit3,
    ...
    },
    {
      ...
      price: 100,
      description:
        "Content management system with blog functionality and SEO tools",
      icon: FileText,
    ...
    },
    {
      ...
      price: 75,
      description:
        "Dedicated team/staff pages with individual profiles and bios",
      icon: Users,
    ...
    },
    {
      ...
      price: 200,
      description:
        "Complete website translation and language switching functionality",
      icon: Globe,
    ...
    },
    {
      ...
      price: 300,
      description:
        "Advanced animations, custom graphics, and premium visual elements",
      icon: Sparkles,
    ...
    },
    {
      ...
      price: 125,
      description:
        "Professional email marketing system with automated sequences",
      icon: Mail,
  ...
  function handleAddonToggle(event: CustomEvent) {
    ...
    conversationalWizard.updateData({
      selectedAddons,
      estimatedTotal: calculateTotalPrice(basePrice, selectedAddons)
        .estimatedTotal,
    });
  }
  ...
  function handleTotalUpdate(event: CustomEvent) {
    const { estimatedTotal: newTotal, selectedAddons: newAddons } =
      event.detail;
...
<div class="max-w-7xl mx-auto px-4 py-8">
  ...
  <div class="text-center mb-8" in:fade={{ duration: 600 }}>
    ...
    <p class="text-lg text-gray-600 max-w-2xl mx-auto">
      Choose the features that will help your business succeed online. Each
      addon is professionally integrated into your website.
    </p>
  </div>
