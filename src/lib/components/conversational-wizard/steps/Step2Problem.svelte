...
<div class="step-container" in:fade={{ duration: 400, delay: 100 }}>
  <div in:fly={{ y: 30, duration: 500 }}>
    ...
    <p class="step-subtitle" in:fly={{ y: 20, duration: 400, delay: 300 }}>
      Dump everything on us. What's bugging you? What do you need? What's the
      dream?
    </p>
    ...
    >
      <div class="icon">💡</div>
      <div class="text">
        <strong>Our specialty:</strong> Taking your messy, incomplete ideas and turning
        them into something that works. The more you tell us—even the scattered thoughts—the
        better we can help.
      </div>
    </div>
