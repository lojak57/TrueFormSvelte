...
<Card class="max-w-5xl mx-auto">
  ...
  <div class="min-h-96">
    ...
    {#if currentStep === 2}
      <div in:fade={{ duration: 300 }}>
        <div class="text-center py-12">
          <h3 class="text-xl font-semibold text-gray-900 mb-4">Project Vision Step</h3>
    ...
    {#if currentStep === 3}
      <div in:fade={{ duration: 300 }}>
        <div class="text-center py-12">
          <h3 class="text-xl font-semibold text-gray-900 mb-4">Website Type & Features</h3>
    ...
    {#if currentStep === 4}
      <div in:fade={{ duration: 300 }}>
        <div class="text-center py-12">
          <h3 class="text-xl font-semibold text-gray-900 mb-4">Design & Branding</h3>
    ...
    {#if currentStep === 5}
      <div in:fade={{ duration: 300 }}>
        <div class="text-center py-12">
          <h3 class="text-xl font-semibold text-gray-900 mb-4">Content & Structure</h3>
    ...
    {#if currentStep === 7}
      <div in:fade={{ duration: 300 }}>
        <div class="text-center py-12">
          <h3 class="text-xl font-semibold text-gray-900 mb-4">Technical Requirements</h3>
    ...
    {#if currentStep === 8}
      <div in:fade={{ duration: 300 }}>
        <div class="text-center py-12">
          <h3 class="text-xl font-semibold text-gray-900 mb-4">Timeline & Budget</h3>
