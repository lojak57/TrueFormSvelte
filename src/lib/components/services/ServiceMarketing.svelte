...
<section class="py-20 bg-gradient-to-br from-accent-50 to-blue-50">
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    <IntersectionObserver threshold={0.3} once={true} let:isVisible>
      {#if isVisible}
        <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12" in:fly={{ y: 50, duration: 800 }}>
          <!-- Header -->
            ...
            <div in:fly={{ x: -50, duration: 600, delay: 400 }}>
              ...
              <div class="space-y-4">
                {#each marketingContent.highlights as highlight, i}
                  ...
                  >
                    <Check size={20} class="text-green-600 mr-3 mt-1 flex-shrink-0" />
          ...
          <!-- Value Proposition -->
          <div class="mt-12 text-center bg-gray-50 rounded-2xl p-8" in:fly={{ y: 30, duration: 600, delay: 800 }}>
            <h3 class="text-2xl font-semibold text-gray-900 mb-4">
              The TrueForm Advantage
            </h3>
            <p class="text-lg text-gray-700 max-w-3xl mx-auto">
              While others charge $5k-15k and take months to deliver, we provide enterprise-quality results 
              at a fraction of the cost in just 7 days. Professional design, modern technology, and ongoing support—all included.
            </p>
          </div>
        </div>
      {/if}
