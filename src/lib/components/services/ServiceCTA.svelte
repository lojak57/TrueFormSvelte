...
<section class="py-20 bg-gray-900 text-white relative overflow-hidden">
  <!-- Background Effects -->
  <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-accent-900/30 via-transparent to-transparent" />
  ...
  <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    <IntersectionObserver threshold={0.3} once={true} let:isVisible>
      {#if isVisible}
        ...
        <!-- Trust Indicators -->
        <div class="grid md:grid-cols-3 gap-8 text-center" in:fly={{ y: 30, duration: 600, delay: 400 }}>
          <div class="flex flex-col items-center">
            ...
            <p class="text-gray-300">From concept to live website in just one week</p>
          </div>
        ...
        <!-- Risk-Free Guarantee -->
        <div class="mt-16 text-center bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10" in:fly={{ y: 30, duration: 600, delay: 600 }}>
          <h3 class="text-2xl font-semibold mb-4">100% Risk-Free Guarantee</h3>
          <p class="text-gray-300 text-lg max-w-2xl mx-auto">
            Not happy with your website? We'll work with you until you love it, or refund your money. 
