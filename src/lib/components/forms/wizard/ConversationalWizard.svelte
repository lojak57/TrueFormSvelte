<script lang="ts">
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      alert(
        "Thank you! Your project request has been submitted. We'll be in touch within 24 hours."
      );
    ...
    switch (step.id) {
      ...
      case "decisionProcess":
        return {
          ...
          placeholder:
            "Who's involved in decisions and how do you typically choose partners?",
          name: step.id,
        };
