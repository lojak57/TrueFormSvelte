<script lang="ts">
  ...
  function addKeyword() {
    if (
      newKeyword.trim() &&
      !selected.keywords.includes(newKeyword.trim().toLowerCase())
    ) {
      selected.keywords = [
        ...selected.keywords,
...
<div class="space-y-8" in:fade={{ duration: 300 }}>
  ...
  <div class="text-center">
    <div
      class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-pink-500 to-orange-500 rounded-2xl mb-6 shadow-xl"
    >
    ...
    <div class="mb-8">
      <p class="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
        Share anything that inspires you - websites, colors, feelings, or just
        describe what you love. This is completely optional but incredibly
        helpful!
      </p>
    </div>
  </div>
      ...
      <div class="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p class="text-sm text-gray-600">
            Any sites you love the look or feel of
          </p>
        </div>
      </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
      <div class="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p class="text-sm text-gray-600">
            How should visitors feel when they see your site?
          </p>
        </div>
      </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
      <div class="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p class="text-sm text-gray-600">
            Words that describe your ideal aesthetic
          </p>
        </div>
      </div>
  ...
  {#if hasContent}
    <div
      class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 max-w-3xl mx-auto border border-purple-200"
      ...
      <div class="space-y-2 text-sm">
        {#if selected.websiteUrls.length > 0}
          <div>
            ...
            <span class="text-gray-600"
              >{selected.websiteUrls.length} reference{selected.websiteUrls
                .length > 1
                ? "s"
                : ""}</span
            >
        ...
        {#if selectedFeeling}
          <div>
            ...
            <span class="text-gray-600"
              >{selectedFeeling.emoji} {selectedFeeling.label}</span
            >
          </div>
        {/if}
        ...
        {#if selected.description.trim()}
          <div>
            ...
            <span class="text-gray-600"
              >"{selected.description.trim().substring(0, 100)}{selected
  ...
  <div class="text-center space-y-4">
    ...
    <p class="text-sm text-gray-500">
      💡 Pro tip: The more inspiration you share, the better we can capture your
      vision
    </p>
  </div>
</div>
