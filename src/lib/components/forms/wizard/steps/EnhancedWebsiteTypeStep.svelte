...
<div class="space-y-8" in:fade={{ duration: 300 }}>
  ...
  <div class="text-center">
    <div
      class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-500 rounded-2xl mb-6 shadow-xl"
    >
    ...
    <div class="mb-8">
      <p class="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
        Each website type is designed for different goals. See exactly what
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
    {#each websiteTypes as type, i}
      ...
      >
        ...
        <div
          class="website-preview bg-gray-50 rounded-lg p-3 mb-4 border border-gray-200"
        >
          <!-- Browser bar -->
          ...
          <div class="bg-white rounded border border-gray-200 p-2 text-xs">
            ...
            <div class="text-center py-2">
              ...
              <div
                class="bg-{type.color}-500 text-white px-2 py-1 rounded text-xs inline-block"
              >
                {type.example.cta}
              </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-1 mt-2">
              {#each Array(3) as _, j}
                <div class="bg-{type.color}-50 p-1 rounded">
                  <div class="w-full h-2 bg-{type.color}-200 rounded mb-1" />
                  <div class="w-2/3 h-1 bg-{type.color}-300 rounded" />
                </div>
              {/each}
            </div>
          </div>
        ...
        <div class="flex items-start gap-3 mb-4">
          ...
          <div class="flex-1">
            <h3
              class="text-lg font-bold text-gray-900 mb-1 group-hover:text-{type.color}-700 transition-colors"
            >
              {type.name}
            </h3>
        ...
        <div class="space-y-1">
          ...
          {#each type.features as feature}
            <div class="flex items-center gap-2 text-xs text-gray-600">
              <div class="w-1 h-1 bg-{type.color}-400 rounded-full" />
              <span>{feature}</span>
            </div>
          {/each}
        </div>
  ...
  {#if selectedType}
    <div
      class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 max-w-4xl mx-auto border border-blue-200"
    ...
    >
      ...
      <div class="grid md:grid-cols-2 gap-6 items-center">
        <!-- Enhanced preview -->
        <div
          class="website-mockup bg-white rounded-xl shadow-lg overflow-hidden"
        >
          <!-- Browser bar -->
          <div class="bg-gray-100 px-3 py-2 flex items-center gap-2">
            ...
            <div
              class="flex-1 bg-white rounded px-2 py-1 text-xs text-gray-600"
            >
              yourcompany.com
            </div>
          </div>
          ...
          <div class="p-4 bg-{selectedType.color}-50">
            ...
            <!-- Navigation -->
            <div
              class="flex gap-3 mb-4 text-xs text-gray-600 border-b border-{selectedType.color}-200 pb-2"
            >
            ...
            <div class="text-center py-6 bg-white rounded-lg mb-4">
              ...
              <div
                class="bg-{selectedType.color}-500 text-white px-4 py-2 rounded inline-block text-sm font-medium"
              >
            ...
            <div class="grid grid-cols-3 gap-2">
              {#each selectedType.features.slice(0, 3) as feature}
                <div class="bg-white p-2 rounded text-center">
                  <div
                    class="w-6 h-6 bg-{selectedType.color}-200 rounded mx-auto mb-1"
                  />
          ...
          <div class="space-y-2">
            {#each selectedType.features as feature}
              <div class="flex items-center gap-3">
                <div
                  class="w-5 h-5 bg-{selectedType.color}-500 rounded-full flex items-center justify-center"
                >
    ...
    {:else}
      <div class="space-y-3">
        ...
        <p class="text-sm text-gray-500">
          💡 Each type is optimized for different business goals
        </p>
      </div>
    {/if}
  </div>
