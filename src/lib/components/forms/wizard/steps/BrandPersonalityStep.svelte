<script lang="ts">
  ...
  const audiences = [
    {
      ...
      description: "Regular people looking for products/services",
      emoji: "👥",
    },
    {
      id: "professionals",
    ...
    },
    {
      ...
      description: "Large corporations and organizations",
      emoji: "🏢",
    },
    {
      id: "small-business",
    ...
    },
    {
      ...
      description: "Early adopters and tech-forward users",
      emoji: "💻",
    },
    {
      id: "luxury",
      name: "Luxury Market",
      description: "High-end, premium market segment",
      emoji: "💎",
    },
    {
      id: "youth",
      name: "Young Adults",
      description: "Millennials and Gen Z audience",
      emoji: "🌟",
    },
  ];
  ...
  const personalities = [
    {
      id: "innovative",
      name: "Innovative",
      description: "Cutting-edge and forward-thinking",
      emoji: "🚀",
    },
    {
      id: "trustworthy",
    ...
    },
    {
      id: "professional",
      name: "Professional",
      description: "Serious and business-focused",
      emoji: "💼",
    },
    {
      id: "creative",
    ...
    },
    {
      id: "premium",
      name: "Premium",
      description: "High-end and exclusive",
      emoji: "👑",
    },
    {
      id: "fun",
    ...
    },
    {
      id: "authentic",
      name: "Authentic",
      description: "Genuine and transparent",
      emoji: "💯",
    },
  ];
  ...
  function togglePersonality(personalityId: string) {
    if (selected.personality.includes(personalityId)) {
      selected.personality = selected.personality.filter(
        (id) => id !== personalityId
      );
  ...
  $: selectedPersonalities = personalities.filter((p) =>
    selected.personality.includes(p.id)
  );
  $: canContinue =
    selected.industry && selected.audience && selected.personality.length > 0;
</script>
...
<div class="space-y-8" in:fade={{ duration: 300 }}>
  ...
  <div class="flex justify-center items-center gap-4 mb-8">
    <div class="flex items-center gap-2">
      ...
      <span
        class="text-sm font-medium {currentStep === 'industry'
          ? 'text-purple-600'
          : 'text-gray-600'}">Industry</span
      >
    </div>

    <div
      class="w-8 h-0.5 bg-gray-200 {selected.industry ? 'bg-green-500' : ''}"
    />
    ...
    <div class="flex items-center gap-2">
      ...
      <span
        class="text-sm font-medium {currentStep === 'audience'
          ? 'text-purple-600'
          : 'text-gray-600'}">Audience</span
      >
    </div>

    <div
      class="w-8 h-0.5 bg-gray-200 {selected.audience ? 'bg-green-500' : ''}"
    />
    ...
    <div class="flex items-center gap-2">
      ...
      <span
        class="text-sm font-medium {currentStep === 'personality'
          ? 'text-purple-600'
          : 'text-gray-600'}">Personality</span
      >
    </div>
  </div>
  ...
  {#if currentStep === "industry"}
    <div in:fly={{ x: -50, duration: 300 }} out:fly={{ x: 50, duration: 200 }}>
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-500 rounded-2xl mb-4"
        >
        ...
        <p class="text-gray-600">
          This helps us understand your market and competition
        </p>
      </div>
        ...
        {#each industries as industry, i}
          ...
          >
            <div class="flex items-start gap-3 mb-3">
              <div
                class="w-12 h-12 rounded-lg bg-{industry.color}-100 flex items-center justify-center"
              >
                <svelte:component
                  this={industry.icon}
                  size={24}
                  class="text-{industry.color}-600"
                />
              </div>
              <div class="flex-1">
            ...
            <div
              class="bg-{industry.color}-50 p-3 rounded-lg border border-{industry.color}-200 group-hover:bg-{industry.color}-100 transition-colors"
            >
  ...
  {#if currentStep === "audience"}
    <div in:fly={{ x: -50, duration: 300 }} out:fly={{ x: 50, duration: 200 }}>
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-500 to-blue-500 rounded-2xl mb-4"
        >
  ...
  {#if currentStep === "personality"}
    <div in:fly={{ x: -50, duration: 300 }} out:fly={{ x: 50, duration: 200 }}>
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl mb-4"
        >
        ...
        <p class="text-gray-600">
          Choose up to 3 traits that define your brand's character
        </p>
      </div>

      <div
        class="grid md:grid-cols-2 lg:grid-cols-4 gap-3 max-w-4xl mx-auto mb-8"
      >
        {#each personalities as personality, i}
          <button
            ...
            disabled={!selected.personality.includes(personality.id) &&
              selected.personality.length >= 3}
            in:scale={{ duration: 200, delay: i * 50 }}
          >
            ...
            {#if selected.personality.includes(personality.id)}
              <div
                class="absolute -top-1 -right-1 w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center text-white text-xs font-bold"
              >
      ...
      <div class="text-center space-y-4">
        ...
        {:else}
          <p class="text-sm text-gray-500">
            Select at least one personality trait to continue
          </p>
        {/if}
      </div>
    </div>
  ...
  {#if selected.industry || selected.audience || selected.personality.length > 0}
    <div
      class="bg-gradient-to-r from-gray-50 to-purple-50 rounded-2xl p-4 max-w-2xl mx-auto border border-purple-200"
      in:fade={{ duration: 300 }}
    >
      <div class="flex flex-wrap gap-3 text-sm">
        {#if selectedIndustry}
          <span
            class="inline-flex items-center gap-1 px-3 py-1 bg-white rounded-full border border-blue-200"
          >
            <svelte:component
              this={selectedIndustry.icon}
              size={14}
              class="text-blue-600"
            />
        ...
        {#if selectedAudience}
          <span
            class="inline-flex items-center gap-1 px-3 py-1 bg-white rounded-full border border-green-200"
          >
        ...
        {#each selectedPersonalities as personality}
          <span
            class="inline-flex items-center gap-1 px-3 py-1 bg-white rounded-full border border-purple-200"
          >
