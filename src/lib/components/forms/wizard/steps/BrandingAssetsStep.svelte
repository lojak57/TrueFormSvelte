...
<div class="space-y-6">
    ...
    {#each brandAssetOptions as option}
      ...
      >
        {#if selected.hasBrandAssets === option.id}
          <div
            class="absolute top-4 right-4 w-8 h-8 bg-accent-600 rounded-full flex items-center justify-center"
          >
    ...
    <div class="space-y-6" in:fade={{ duration: 300 }}>
      <div class="border-t pt-6">
        ...
        <p class="text-sm text-gray-600 mb-6">
          Upload any existing brand materials you have. Don't worry if you don't
          have everything - we can work with whatever you provide!
        </p>
        ...
        <div class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <ul class="text-sm text-blue-800 space-y-1">
            <li>
              • High-resolution logo files work best (PNG or SVG preferred)
            </li>
            <li>
              • Include both light and dark versions of your logo if available
            </li>
            <li>
              • Brand guidelines help us match your existing style perfectly
            </li>
            <li>
              • Don't have everything? No problem - we can work with what you
              have!
            </li>
          </ul>
        </div>
  ...
  {#if selected.hasBrandAssets === "yes" && uploadedFiles.length === 0}
    <p class="text-center text-sm text-gray-500">
      You can upload files now or send them to us later - whatever works best
      for you!
    </p>
  {/if}
</div>
