<script lang="ts">
  ...
  $: calculatePricing = () => {
    ...
    const baseFeatures = features.filter((f: string) => !PRICING_MODEL.addOnCosts[f]);
    const premiumFeatures = features.filter((f: string) => PRICING_MODEL.addOnCosts[f]);
    ...
    if (timeline === 'asap') {
      addOns.push({ name: 'rushDelivery', price: PRICING_MODEL.addOnCosts.rushDelivery });
      total += PRICING_MODEL.addOnCosts.rushDelivery;
    }
    
    return { isEnterprise: false, total, addOns, monthlyPayment: Math.ceil(total / 12) };
  };
      ...
      case 'brandingAssets':
        if (typeof value === 'object' && value.hasBrandAssets) {
          if (value.hasBrandAssets === 'yes') {
            ...
            return `Yes - ${fileCount} file${fileCount !== 1 ? 's' : ''} uploaded`;
          } else {
...
<div class="space-y-6">
  <div class="text-center mb-8">
    ...
    <p class="text-gray-600">
      Take a moment to review your information. You can edit any section before submitting.
    </p>
  </div>
  ...
  <!-- Pricing Summary -->
  <div class="bg-gradient-to-r from-accent-50 to-orange-50 rounded-xl p-6 border border-accent-200">
    ...
    {#if pricing.isEnterprise}
      ...
      <div class="space-y-4">
        <div class="text-center py-6">
          <div class="text-3xl font-bold text-purple-600 mb-2">Custom Quote</div>
          <p class="text-gray-600 mb-4">Enterprise features require tailored pricing</p>
          
          <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
            <p class="text-sm font-medium text-purple-800 mb-2">Enterprise Features Selected:</p>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div class="flex items-start gap-2">
            ...
            <div class="text-sm text-blue-800">
              ...
              <p>We'll analyze your requirements and provide a detailed proposal within 48 hours.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-3">
        <div class="flex justify-between items-center">
          <div>
            ...
            <p class="text-sm text-gray-600">Includes up to 6 features, 10 pages, and more</p>
          </div>
          ...
          <div class="border-t pt-3 space-y-2">
            ...
            {#each pricing.addOns as addon}
              <div class="flex justify-between items-center pl-4">
                <p class="text-sm text-gray-600">{FEATURE_DISPLAY_NAMES[addon.name] || addon.name}</p>
        ...
        <div class="border-t pt-3">
          <div class="flex justify-between items-center">
            <div>
              ...
              <p class="text-sm text-gray-600">or ${pricing.monthlyPayment}/month with Klarna</p>
            </div>
