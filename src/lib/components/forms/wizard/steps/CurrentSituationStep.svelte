  ...
  const situationOptions = [
    {
      ...
      description:
        "Outdated design, poor mobile experience, or missing features",
      icon: Settings,
...
<div class="premium-step" in:fade={{ duration: 400 }}>
  ...
  <div class="text-center mb-12">
    ...
    >
      Understanding your current challenge helps us design the perfect solution
            ...
            <div class="relative z-10 p-6">
              ...
              <div class="flex items-start justify-between mb-4">
                ...
                <div class="text-right">
                  <span
                    class="inline-block px-2 py-1 text-xs font-medium rounded-lg
                              {option.priority === 'Critical Priority'
                      ? 'bg-red-100 text-red-700'
                      : option.priority === 'High Priority'
              ...
              <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                ...
                <div class="flex items-center justify-center mt-2">
                  <div
                    class="w-8 h-0.5 bg-gradient-to-r from-gray-300 to-green-500 rounded-full"
                  />
                  <div class="w-2 h-2 bg-green-500 rounded-full ml-1" />
                </div>
              </div>
            </div>
          </div>
    ...
    >
      ...
      <div class="flex items-center gap-4 justify-center mb-6">
        ...
        >
          ...
          <span
            class="text-sm px-2 py-1 bg-orange-100 text-orange-700 rounded-lg font-medium"
          >
