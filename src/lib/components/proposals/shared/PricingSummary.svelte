...
<div class="tf-card">
  <div class="tf-card-header">
    ...
    <p class="tf-text-muted text-sm">{lineItemCount} {lineItemCount === 1 ? 'item' : 'items'}</p>
  </div>
  ...
  <div class="tf-card-body space-y-4">
    ...
    <div class="space-y-3">
      ...
      <div class="flex justify-between items-center text-lg">
        ...
        <span class="tf-heading-3 text-primary-600">{formatCurrency(total)}</span>
      </div>
    </div>
      ...
      <div class="mt-6 p-4 bg-blue-50 rounded-lg">
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-blue-700 mt-1">50% deposit required to begin work. Final payment due upon project completion.</p>
          </div>
        </div>
      </div>
    {/if}
