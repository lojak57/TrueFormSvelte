<script lang="ts">
  import { SERVICE_CATEGORIES, getServicesByCategory } from '$lib/data/serviceTemplates';
...
<div class="mb-8">
  ...
  <div class="flex items-center gap-3 mb-6">
    <div class="w-10 h-10 rounded-lg {categoryInfo.color} flex items-center justify-center text-lg">
      {categoryInfo.icon}
    </div>
    <div>
