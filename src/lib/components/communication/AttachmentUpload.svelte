		...
		<div class="p-6">
			...
			>
				...
				<p class="text-xs text-gray-500">
					Max file size: {formatFileSize(maxFileSize)} • Supported: Images, PDFs, Documents
				</p>
			</div>
			...
			{#if files.length > 0}
				<div class="mb-6">
					<h3 class="text-sm font-medium text-gray-900 mb-3">Selected Files ({files.length})</h3>
