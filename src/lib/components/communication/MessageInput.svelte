...
{#if replyingTo}
	<div class="px-4 py-2 bg-blue-50 border-l-4 border-blue-400 flex items-start justify-between">
		<div class="flex-1 min-w-0">
			<div class="text-sm font-medium text-blue-900">
				Replying to {formatUserName(replyingTo.sender.first_name, replyingTo.sender.last_name)}
			</div>
...
{:else if editingMessage}
	<div class="px-4 py-2 bg-amber-50 border-l-4 border-amber-400 flex items-start justify-between">
		<div class="flex-1 min-w-0">
