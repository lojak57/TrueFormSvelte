...
<ConfirmDialog
  ...
  message="Are you sure you want to delete {contact?.first_name} {contact?.last_name}? This action cannot be undone and will also delete all interaction history."
