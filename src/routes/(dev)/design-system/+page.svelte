...
<svelte:head>
  ...
  <meta
    name="description"
    content="TrueForm Design System showcase - components, tokens, and patterns."
  />
</svelte:head>

<div class="container mx-auto py-8 space-y-12">
  <header class="text-center space-y-4">
    <h1 class="text-hero font-heading font-bold text-primary">
      TrueForm Design System
    </h1>
  ...
  <section class="space-y-6">
    ...
    <div class="flex gap-4 flex-wrap">
      <BaseButton on:click={() => switchTheme("default")}
        >Default Theme</BaseButton
      >
      <BaseButton variant="secondary" on:click={() => switchTheme("golf")}
        >Golf Theme</BaseButton
      >
      <BaseButton variant="outline" on:click={() => switchTheme("oilfield")}
        >Oilfield Theme</BaseButton
      >
    </div>
  </section>
    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <div class="space-y-2">
          <div
            class="w-full h-16 rounded-lg"
            style="background-color: var(--color-warn);"
          />
    ...
    <div class="space-y-4">
      ...
      <div class="space-y-3">
        ...
        <div class="text-caption text-muted">
          Caption text (14px) - Additional information
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="space-y-8">
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        >
          <div class="space-y-3">
            ...
            <p class="text-muted">
              Large card perfect for featured content and primary actions.
            </p>
        ...
        >
          <div class="space-y-3">
            ...
            <p class="text-muted">
              Medium-sized card for content lists and grids.
            </p>
    ...
    <div class="space-y-6">
      ...
      <div class="space-y-4">
        ...
        <div class="flex gap-4 flex-wrap">
          <BaseButton on:click={handleButtonClick} loading={loadingButton}
            >Primary</BaseButton
          >
      ...
      <div class="grid md:grid-cols-2 gap-6">
        <div class="space-y-4">
          ...
          <BaseInput
            ...
            error={emailValue && !emailValue.includes("@")
        ...
        <div class="space-y-4">
          ...
          <BaseInput
            ...
            disabled
            value="https://true-form-apps.com"
          />
        </div>
      </div>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-6">
      <BaseCard variant="compact" class="card-hover">
        <div class="space-y-3">
          ...
          <p class="text-muted">
            Hover over this card to see the accent bar animation.
          </p>
        </div>
      </BaseCard>
