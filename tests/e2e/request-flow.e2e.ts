...
test.describe('Project Request Form', () => {
  ...
  test('form loads with all required fields', async ({ page }) => {
    ...
    await expect(page.locator('input[type="text"][name*="name"]')).toBeVisible();
    await expect(page.locator('input[type="email"][name*="email"]')).toBeVisible();
    await expect(page.locator('input[type="tel"][name*="phone"]')).toBeVisible();
  ...
  test('validates required fields', async ({ page }) => {
    ...
    await expect(page.locator('text=required', { hasText: /name.*required/i })).toBeVisible();
    await expect(page.locator('text=required', { hasText: /email.*required/i })).toBeVisible();
  ...
  test('budget selection works', async ({ page }) => {
    ...
    const budgetOptions = page.locator('input[type="radio"], select[name*="budget"]');
  ...
  test('timeline selection functions', async ({ page }) => {
    ...
    const timelineOptions = page.locator('text=1-2 weeks, text=1-2 months, text=3+ months');
  ...
  test('completes successful form submission', async ({ page }) => {
    ...
    // Fill description
    await page.fill('textarea', 'I need a professional marketing website for my business.');
  ...
  test('handles form submission errors gracefully', async ({ page }) => {
    ...
    await expect(page.locator('text=error, text=try again, text=problem')).toBeVisible({ timeout: 10000 })
      .or(page.locator('text=success, text=submitted')).toBeVisible({ timeout: 10000 });
  });
